...
export default function Header() {
  ...
  return (
    <div className='fixed h-[32px] sm:h-[40px] px-[20px] my-[22px]  lg:my-[42px] flex justify-between items-center text-[10px] sm:text-[16px] font-normal font-Poppins leading-normal'>
